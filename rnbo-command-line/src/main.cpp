...
int main(int argc, const char * argv[]) {
  ...
  // Print out some input file info
  std::cout << "input frames " << inputInfo.frames << "\n";
  std::cout << "input channels " << inputInfo.channels << "\n";

  // Use the same format to open the output for writing
